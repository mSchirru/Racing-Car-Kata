...
namespace TDDMicroExercises.LeaderBoard
{
    public class Leaderboard
    {
        ...
        public Dictionary<string, int> UpdateDriverResults() //Change Function Declaration
        {
        ...
        {
            //var results = DriverResults(); //Replace temp with query
            var resultsList = new List<string>(UpdateDriverResults().Keys);
            resultsList.Sort();
            return resultsList;
